...
VALUES (1, 'xxl-job-executor-sample', '示例执行器', 0, NULL, '2021-09-24 18:55:31.5');
COMMIT;
...
VALUES (2, '2021-09-21 00:00:00', 0, 0, 0, NULL);
INSERT INTO "xxl_job_log_report"
VALUES (3, '2021-09-20 00:00:00', 0, 0, 0, NULL);
INSERT INTO "xxl_job_log_report"
VALUES (5, '2021-09-24 00:00:00', 0, 0, 0, NULL);
INSERT INTO "xxl_job_log_report"
VALUES (4, '2021-09-23 00:00:00', 0, 0, 0, NULL);
INSERT INTO "xxl_job_log_report"
VALUES (1, '2021-09-22 00:00:00', 0, 0, 0, NULL);
COMMIT;
...
VALUES (1, 'mija_admin', '65dd856a230a3c209466812e5583f729', 1, NULL);
INSERT INTO "xxl_job_user"
VALUES (0, 'libai', 'ad942938834a3657d8dcf5279d749b8f', 0, '');
COMMIT;
...
CREATE INDEX "i_trigger_day" ON "xxl_job_log_report" USING btree (
                                                                  "trigger_day" "pg_catalog"."timestamp_ops" ASC NULLS
                                                                  LAST
    );
